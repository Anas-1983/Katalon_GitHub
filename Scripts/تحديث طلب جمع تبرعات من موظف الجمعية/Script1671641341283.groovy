...
WebUI.callTestCase(findTestCase('تسجيل دخول موظف جمعية'), [:], FailureHandling.STOP_ON_FAILURE)

'خدمات التحصيل'
WebUI.setText(findTestObject('Organization Emploee_Home Page/input__search'), 'جمع تبرعات')

WebUI.click(findTestObject('Organization Emploee_Home Page/mark_Fundraising'), FailureHandling.STOP_ON_FAILURE)
...
'استعراض قائمة بالتراخيص القديمة'
WebUI.click(findTestObject('Organization Emploee_Home Page/Collection Services/Fundraising/button__Old licenses display button'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2)

'أول ترخيص في القائمة'
WebUI.click(findTestObject('Organization Emploee_Home Page/Collection Services/Fundraising/button_First old license button (licenses popup screen)'), 
    FailureHandling.STOP_ON_FAILURE)
...
'التأكد من حفظ الطلب'
WebUI.verifyTextPresent('تم أضافة الطلب بنجاح', false, FailureHandling.CONTINUE_ON_FAILURE)
