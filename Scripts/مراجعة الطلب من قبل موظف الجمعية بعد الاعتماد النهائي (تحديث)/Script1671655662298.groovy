...
WebUI.setText(findTestObject('Organization Emploee_Home Page/User Inbox/input_request search'), GlobalVariable.RequestNumber)
...
WebUI.verifyElementText(findTestObject('Organization Emploee_Home Page/User Inbox/span_Status field'), 'اعتماد نهائي')

WebUI.verifyTextPresent('رخصة', false)

WebUI.verifyTextPresent(GlobalVariable.RequestNumber, false)
...
WebUI.verifyTextPresent(GlobalVariable.LicenseNumber, false)

WebUI.verifyTextPresent('تحديث', false)
